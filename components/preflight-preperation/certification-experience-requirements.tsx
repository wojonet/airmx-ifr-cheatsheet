...
export interface CertificationExperienceRequirementsProps {
  sectionId: string
}
...
const CertificationExperienceRequirements = ({
  sectionId,
  innerRef,
}: CertificationExperienceRequirementsProps & { innerRef: React.ForwardedRef<any> }) => {
  return (
    <>
      <section ref={innerRef} id={sectionId}>
...
export default React.forwardRef((props: CertificationExperienceRequirementsProps, ref) => (
  <CertificationExperienceRequirements sectionId={props.sectionId} innerRef={ref} />
))
